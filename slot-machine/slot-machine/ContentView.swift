...
struct ContentView: View {
    ...
    public var symbols = ["eating", "happy", "love", "sleeping", "scary"]
    ...
    var body: some View {
        ZStack{
            ...
            .alert(item: $showingAlert) { alert -> Alert in
                ...
                case.failure:
                    return Alert(title: Text("Ooooppsss"), message: Text("Better luck next time"), dismissButton: .cancel())
